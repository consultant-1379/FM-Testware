...
public class HeartBeatDataProvider implements DataProvider {

	public static final String DATA_FILE = "NetsimSnmpNEHBData.txt";

	public static List<String> getHBTestData() {
