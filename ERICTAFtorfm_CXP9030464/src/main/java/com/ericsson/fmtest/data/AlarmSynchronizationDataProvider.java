...
public class AlarmSynchronizationDataProvider implements DataProvider {

	public static final String DATA_FILE = "SupervisionData.txt";

	public static List<String> getSyncTestData() {
	...
	/**
	 * TODO Use the getHostsByName function and modify the properties file accordingly
	 * @return
	 */
