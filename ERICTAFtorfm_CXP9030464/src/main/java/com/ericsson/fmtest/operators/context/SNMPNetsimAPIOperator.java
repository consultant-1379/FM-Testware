...
public class SNMPNetsimAPIOperator implements ApiOperator {

	SNMPNetsimOperations netsimOperations = new SNMPNetsimOperations();
	NetsimNE node = new NetsimNE();
	ActionSender action = new ActionSender();
	

	private static final Logger LOGGER = Logger
			.getLogger(SNMPNetsimAPIOperator.class);
	...
	public String raiseAlarm(String fdn, String neType, String simulationName,
			String neName, String spText, String severity,Host host) throws Exception {
	...
	public String[] raiseDefaultAlarm(String simulationName, String neName, String neType)
		...
		results[0] = netsimOperations.raiseTestAlarm(simulationName, neName, neType);
		Thread.sleep(2);
		results[1] = getDefaultAlarmResult(neName, 0).toString();
		 return results;
	}
	...
	public String raiseDefaultClearAlarm(String simulationName, String neName,
			String neType, String alarmId) throws Exception {
		netsimOperations.raiseTestClearAlarm(simulationName, neName, neType, alarmId);
		Thread.sleep(2);
	...
	public String raiseDefaultSNMPClearAlarm(String simulationName, String neName,
			String neType, String alarmId) throws Exception {
		netsimOperations.raiseTestSNMPClearAlarm(simulationName, neName, neType, alarmId);
		Thread.sleep(2);
		return getDefaultAlarmResult(neName, 1).toString();
	}
	...
	public String getDefaultAlarmResult(String neName, int clearFlag)
		...
		try {
			Utils.sleep(NetsimAPIOperatorAPIGetter.SLEEPTIME);
	...
	public void ceaseAllAlarms(String simulationName, String neName) {
		netsimOperations.ceaseAllAlarms(simulationName, neName);
	}
}
