...
public class NetsimAlarms extends TorTestCaseHelper implements TestCase {

	NetsimOperator netsimOperator = new NetsimOperator();

	@Test(dataProvider = "NetsimAlarmsTestData", dataProviderClass = NetsimAlarmsTestData.class)
	public void sendAlarmTest(String testData, Map<String, String> attributes) {
